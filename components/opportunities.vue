<template>
    <div class="max-w-screen-lg mx-auto p-4">
      ...
      <div class="text-center mb-4">
        ...
        <div class="flex justify-center items-center text-red-600 mt-2">
          <img height="24" width="24" src="https://ae01.alicdn.com/kf/S1fa2ebed8eb04c4597523704c386ff5ag/48x48.gif" class="cards--dynamicImg--3M667J1" data-spm-anchor-id="a2g0o.home.superdeal.i9.4c5f10d0KjStDr">
          Bitiş: {{ countdown }}
        </div>
      </div>
          ...
          >
            ...
            >
              ...
              <div class="mt-1 flex items-center justify-between">
                <span class="text-red-600 font-semibold">{{ product.price }}TL</span>
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const products = ref<Product[]>([
        {
          ...
          oldPrice: 75.11,
          discount: 64,
          image: "https://ae-pic-a1.aliexpress-media.com/kf/Sf705fb04bb3043389c00ea8eeb9a5551h.png_480x480.png_.webp",
        },
        {
          ...
          oldPrice: 62.87,
          discount: 42,
          image: "https://ae-pic-a1.aliexpress-media.com/kf/H98df8c631b64474e9e560b957375d1f4c.jpg_480x480.jpg_.webp",
        },
        {
          ...
          oldPrice: 56.33,
          discount: 32,
          image: "https://ae-pic-a1.aliexpress-media.com/kf/S6a75e5ebd38045b4a32d245d30e01df6e.jpg_480x480.jpg_.webp",
        },
        {
          ...
          oldPrice: 78.99,
          discount: 43,
          image: "https://ae-pic-a1.aliexpress-media.com/kf/S6d11be9c50b148f2928e924a3dd958a9N.jpg_480x480.jpg_.webp",
        },
        {
          name: "Yeni model akıllı saat ekran koruyucu...",
          price: 45.29,
          oldPrice: 78.99,
          discount: 43,
          image: "https://ae-pic-a1.aliexpress-media.com/kf/Se8a368aa85434fcb80be6d3b282f3876X.png_480x480.png_.webp",
        },
        {
          name: "Yeni model akıllı saat ekran koruyucu...",
          price: 45.29,
          oldPrice: 78.99,
          discount: 43,
          image: "https://ae-pic-a1.aliexpress-media.com/kf/Sfb17027661ad47ed9b60927d62c614a46.jpg_480x480.jpg_.webp",
        },
      ]);
      ...
      // Geriye doğru sayma için kalan süre (örnek olarak 24 saat sonrasına ayarlandı)
      ...
      // Zamanlayıcı
      let timer: ReturnType<typeof setInterval>; // Doğru türleme
      onMounted(() => {
        updateCountdown();
  ...
  <style scoped>
  /* TailwindCSS kullanıldığı için ek bir özel stil eklemedim. */
  </style>
