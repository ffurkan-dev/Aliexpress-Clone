<template>
    <div class="w-64 bg-gray-100 h-full p-4">
      <h2 class="font-semibold text-lg mb-4">Hesap</h2>
      <ul>
        <li
      ...
      <div class="mt-8">
        ...
        <p class="text-gray-400 text-xs mt-1">Her zaman, Anywhere ara!</p>
        <div class="mt-2">
          <img
        ...
        <p class="text-gray-400 text-xs mt-2">Tarama veya indirmek için tıklayın</p>
      </div>
    </div>
  </template>
  ...
  export default {
    data() {
      return {
        ...
        selectedItem: 0, // Varsayılan olarak ilk öğe seçili
      };
    },
    methods: {
      selectItem(index) {
  ...
  <style>
  /* Tailwind'in kendi yapısını kullandığımız için ekstra CSS eklemeye gerek yok. */
  </style>
